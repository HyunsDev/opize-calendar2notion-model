...
export const getAdminFindUser: Endpoint<
...
export const getAdminUser: Endpoint<
...
export const deleteAdminUser: Endpoint<
...
export const patchAdminUser: Endpoint<
...
export const getAdminFindUsers: Endpoint<
    GetAdminFindUsersParameter,
    GetAdminFindUsersResponse
> = {
    method: 'GET',
    path: '/admin/users',
